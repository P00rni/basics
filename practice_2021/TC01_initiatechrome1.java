...
public class TC01_initiatechrome1 {
	...
	public static void main(String[] args) {
		...
		CDriver.findElement(By.xpath("//*[@value='Google Search'")).sendKeys(Keys.RETURN); // sendKeys(Keys.RETURN) - enter key on keyboard-instead of submit
