...
public class TC002_ElementLocator_xpathElements {
...
WebDriver CDriver = new ChromeDriver();
		...
		CDriver.get("https://translate.google.co.uk/");  // open the website in chrome.
		
		CDriver.findElement(By.xpath("//*[@id=\\\"c63\\\"]")).click();
		
		WebElement Lang = CDriver.findElement(By.xpath("	//*[@id=\"yDmH0d\"]"));
